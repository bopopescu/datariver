...
var MySQLErrName = map[uint16]string{
	...
	ErrFlushMainBinlogClosed:                  "Binlog closed, cannot RESET MASTER",
	ErrIndexRebuild:                             "Failed rebuilding the index of  dumped table '%-.192s'",
	ErrMain:                                   "Error from main: '%-.64s'",
	ErrMainNetRead:                            "Net error reading from main",
	ErrMainNetWrite:                           "Net error writing to main",
	...
	ErrSubordinateMustStop:                            "This operation cannot be performed with a running subordinate; run STOP SLAVE first",
	ErrSubordinateNotRunning:                          "This operation requires a running subordinate; configure subordinate and do START SLAVE",
	ErrBadSubordinate:                                 "The server is not configured as subordinate; fix in config file or with CHANGE MASTER TO",
	ErrMainInfo:                               "Could not initialize main info structure; more error messages can be found in the MySQL error log",
	ErrSubordinateThread:                              "Could not create subordinate thread; check system resources",
	...
	ErrConnectToMain:                          "Error connecting to main: %-.128s",
	ErrQueryOnMain:                            "Error running query on main: %-.128s",
	...
	ErrMainFatalErrorReadingBinlog:            "Got fatal error %d from main when reading data from binary log: '%-.320s'",
	ErrSubordinateIgnoredTable:                        "Subordinate SQL thread ignored the query because of replicate-*-table rules",
	...
	ErrSubordinateWasRunning:                          "Subordinate is already running",
	ErrSubordinateWasNotRunning:                       "Subordinate already has been stopped",
	...
	ErrSubordinateIgnoredSslParams:                    "SSL parameters in CHANGE MASTER are ignored because this MySQL subordinate was compiled without SSL support; they can be used later if MySQL subordinate with SSL is started",
	...
	ErrBadSubordinateUntilCond:                        "Incorrect parameter or combination of parameters for START SLAVE UNTIL",
	ErrMissingSkipSubordinate:                         "It is recommended to use --skip-subordinate-start when doing step-by-step replication with START SLAVE UNTIL; otherwise, you will get problems if you get an unexpected subordinate's mysqld restart",
	...
	ErrBinlogRowWrongTableDef:                   "Table definition on main and subordinate does not match: %s",
	ErrBinlogRowRbrToSbr:                        "Subordinate running with --log-subordinate-updates must use row-based binary logging to be able to replicate row-based binary log events",
	...
	ErrSubordinateIncident:                            "The incident %s occurred on the main. Message: %-.64s",
	...
	ErrSubordinateFatal:                               "Fatal : %s",
	ErrSubordinateRelayLogReadFailure:                 "Relay log read failure: %s",
	ErrSubordinateRelayLogWriteFailure:                "Relay log write failure: %s",
	ErrSubordinateCreateEventFailure:                  "Failed to create %s",
	ErrSubordinateMainComFailure:                    "Main command %s failed: %s",
	...
	ErrNeverUsed:                                "Ambiguous subordinate modes combination. %s",
	...
	ErrSubordinateCorruptEvent:                                     "Corrupted replication event was detected",
	...
	WarnNoMainInfo:                                         "The main info structure does not exist",
	...
	ErrSubordinateHeartbeatFailure:                                 "Unexpected main's heartbeat data: %s",
	ErrSubordinateHeartbeatValueOutOfRange:                         "The requested value for the heartbeat period is either negative or exceeds the maximum allowed (%s seconds).",
	...
	ErrSubordinateIgnoreServerIds:                                  "The requested server id %d clashes with the subordinate startup option --replicate-same-server-id",
	...
	ErrBinlogUnsafeSystemTable:                               "The statement is unsafe because it uses the general log, slow query log, or performanceSchema table(s). This is unsafe because system tables may differ on subordinates.",
	...
	ErrBinlogUnsafeUdf:                                       "Statement is unsafe because it uses a UDF which may not return the same value on the subordinate.",
	ErrBinlogUnsafeSystemVariable:                            "Statement is unsafe because it uses a system variable that may have a different value on the subordinate.",
	ErrBinlogUnsafeSystemFunction:                            "Statement is unsafe because it uses a system function that may return a different value on the subordinate.",
	...
	ErrSubordinateConversionFailed:                                 "Column %d of table '%-.192s.%-.192s' cannot be converted from type '%-.32s' to type '%-.32s'",
	ErrSubordinateCantCreateConversion:                             "Can't create conversion table for table '%-.192s.%-.192s'",
	...
	ErrSubordinateHeartbeatValueOutOfRangeMin:                      "The requested value for the heartbeat period is less than 1 millisecond. The value is reset to 0, meaning that heartbeating will effectively be disabled.",
	ErrSubordinateHeartbeatValueOutOfRangeMax:                      "The requested value for the heartbeat period exceeds the value of `subordinateNetTimeout' seconds. A sensible value for the period should be less than the timeout.",
	...
	ErrBinlogUnsafeInsertIgnoreSelect:                        "INSERT IGNORE... SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are ignored. This order cannot be predicted and may differ on main and the subordinate.",
	ErrBinlogUnsafeInsertSelectUpdate:                        "INSERT... SELECT... ON DUPLICATE KEY UPDATE is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are updated. This order cannot be predicted and may differ on main and the subordinate.",
	ErrBinlogUnsafeReplaceSelect:                             "REPLACE... SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are replaced. This order cannot be predicted and may differ on main and the subordinate.",
	ErrBinlogUnsafeCreateIgnoreSelect:                        "CREATE... IGNORE SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are ignored. This order cannot be predicted and may differ on main and the subordinate.",
	ErrBinlogUnsafeCreateReplaceSelect:                       "CREATE... REPLACE SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are replaced. This order cannot be predicted and may differ on main and the subordinate.",
	ErrBinlogUnsafeUpdateIgnore:                              "UPDATE IGNORE is unsafe because the order in which rows are updated determines which (if any) rows are ignored. This order cannot be predicted and may differ on main and the subordinate.",
	...
	ErrBinlogUnsafeWriteAutoincSelect:                        "Statements writing to a table with an auto-increment column after selecting from another table are unsafe because the order in which rows are retrieved determines what (if any) rows will be written. This order cannot be predicted and may differ on main and the subordinate.",
	ErrBinlogUnsafeCreateSelectAutoinc:                       "CREATE TABLE... SELECT...  on a table with an auto-increment column is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are inserted. This order cannot be predicted and may differ on main and the subordinate.",
	...
	ErrMainDelayValueOutOfRange:                            "The requested value %d for the main delay exceeds the maximum %d",
	...
	ErrMtsFeatureIsNotSupported:                              "%s is not supported in multi-threaded subordinate mode. %s",
	...
	ErrInsecureChangeMain:                                  "Storing MySQL user name or password information in the main.info repository is not secure and is therefore not recommended. Please see the MySQL Manual for more about this issue and possible alternatives.",
	...
	ErrSQLthreadWithSecureSubordinate:                              "Setting authentication options is not possible when only the Subordinate SQL Thread is being started.",
	...
	ErrBadSubordinateAutoPosition:                                  "Parameters MASTERLOGFILE, MASTERLOGPOS, RELAYLOGFILE and RELAYLOGPOS cannot be set when MASTERAUTOPOSITION is active.",
	...
	ErrGtidModeRequiresBinlog:                                "@@GLOBAL.GTIDMODE = ON or UPGRADESTEP1 or UPGRADESTEP2 requires --log-bin and --log-subordinate-updates.",
	...
	ErrMainHasPurgedRequiredGtids:                          "The subordinate is connecting using CHANGE MASTER TO MASTERAUTOPOSITION = 1, but the main has purged binary logs containing GTIDs that the subordinate requires.",
	...
	ErrSubordinateConfiguration:                                    "Subordinate is not configured or failed to initialize properly. You must at least set --server-id to enable either a main or a subordinate. Additional error messages can be found in the MySQL error log.",
	...
	ErrMtsChangeMainCantRunWithGaps:                        "CHANGE MASTER cannot be executed when the subordinate was stopped with an error or killed in MTS mode. Consider using RESET SLAVE or START SLAVE UNTIL.",
	...
	ErrGtidNextTypeUndefinedGroup:                            "When @@SESSION.GTIDNEXT is set to a GTID, you must explicitly set it again after a COMMIT or ROLLBACK. If you see this error message in the subordinate SQL thread, it means that a table in the current transaction is transactional on the main and non-transactional on the subordinate. In a client connection, it means that you executed SET @@SESSION.GTIDNEXT before a transaction and forgot to set @@SESSION.GTIDNEXT to a different identifier or to 'AUTOMATIC' after COMMIT or ROLLBACK. Current @@SESSION.GTIDNEXT is '%s'.",
	...
	ErrSQLSubordinateSkipCounterNotSettableInGtidMode:              "sqlSubordinateSkipCounter can not be set when the server is running with @@GLOBAL.GTIDMODE = ON. Instead, for each transaction that you want to skip, generate an empty transaction with the same GTID as the transaction",
